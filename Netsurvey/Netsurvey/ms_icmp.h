...
typedef struct ip_option_information {
    u_TCHAR Ttl;		/* Time To Live (used for traceroute) */
    u_TCHAR Tos; 	/* Type Of Service (usually 0) */
    u_TCHAR Flags; 	/* IP header flags (usually 0) */
    u_TCHAR OptionsSize; /* Size of options data (usually 0, max 40) */
    u_TCHAR FAR *OptionsData;   /* Options data buffer */
